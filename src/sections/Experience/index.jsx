        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col gap-y-4">
                ...
                <div className="text-left flex gap-4 text-sm">
                    <div className="hover:text-primaryBase font-medium bg-primaryTitle px-2 py-1 rounded-md text-gray-100">React</div>
                    <div className="hover:text-primaryBase font-medium bg-primaryTitle px-2 py-1 rounded-md text-gray-100">Tailwind</div>
                </div>
            </div>
        </div>
        </div>
